...
<div class="grade-dupla">
    <div class="cartao">
        ...
        <form action="../actions/importar_upload.php" method="POST" enctype="multipart/form-data">
            <?= csrfCampo() ?>
            ...
            <div class="form-grupo" id="grupo-nova-conta" style="display:none;">
                ...
                <input type="text" id="nome_nova_conta" name="nome_nova_conta" placeholder="Ex: Nubank, Banco do Brasil, Caixa da loja">
            </div>
